...
@section('title','Add Chairman Message')
...
<div class="bg-light rounded">
    <div class="card">
        <div class="card-body">
            ...
            <h5>Add Chairman Message</h5>

            <form id="chairmanCreateForm" enctype="multipart/form-data">
                @csrf
...
$('#chairmanCreateForm').submit(function(e){
    e.preventDefault();
    ...
    $.ajax({
        url:"{{ route('manage-chairmen.store') }}",
        type:"POST",
        data:fd,
        processData:false,
        contentType:false,
