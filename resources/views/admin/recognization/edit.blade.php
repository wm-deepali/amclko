...
@section('title','Edit Recognization')
...
<div class="bg-light rounded">
    <div class="card">
        <div class="card-body">
            ...
            <h5>Edit Govt Recognization</h5>

            <form id="recEditForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title"
                           value="{{ $recognization->title }}"
                           class="form-control" required>
                </div>

                @if($recognization->image)
                <div class="mb-3">
                    <img src="{{ asset('storage/'.$recognization->image) }}"
...
{!! $recognization->content !!}
                ...
                <div class="mb-3">
                    ...
                    <select name="status" class="form-control">
                        <option value="active" {{ $recognization->status=='active'?'selected':'' }}>
                            Active
                        </option>
                        <option value="block" {{ $recognization->status=='block'?'selected':'' }}>
                            Blocked
                        </option>
                    </select>
                </div>
