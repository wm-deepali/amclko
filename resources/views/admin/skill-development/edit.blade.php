...
@section('title','Edit Skill Development')
...
<div class="bg-light rounded">
    <div class="card">
        <div class="card-body">
            ...
            <h5>Edit Skill Development</h5>

            <form id="skillEditForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
...
{!! $skill->content !!}
                ...
                <div class="mb-3">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="block" {{ $skill->status=='block'?'selected':'' }}>
                            Blocked
                        </option>
                    </select>
                </div>
